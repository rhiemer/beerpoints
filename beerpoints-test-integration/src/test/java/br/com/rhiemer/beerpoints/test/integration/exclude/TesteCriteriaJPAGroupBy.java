...
public class TesteCriteriaJPAGroupBy implements ExcludeTeste, IntegrationTeste {
	...
	public static Archive<?> createTestableDeployment() {
		...
		return BeerPointstWSUtilsArquillian.gerarDeployment(TesteCriteriaJPAGroupBy.class);
	}
